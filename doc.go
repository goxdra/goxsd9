...
// immutable occurrence ranges. Sequence particles are query-only until
// validation repetition is implemented.
//
...
// only character data; attributes, broader particles, and semantics remain
