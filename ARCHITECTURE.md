...
Long-family refs retain bounds: `long`
`[-9223372036854775808, 9223372036854775807]`, `unsignedLong`
`[0, 18446744073709551615]`, `negativeInteger` upper `-1`, `nonNegativeInteger`
lower `0`, and `nonPositiveInteger` upper `0`; malformed refs invalid.
Built-in/named `nonNegativeInteger` roots validate; other long-family roots
query-only.
