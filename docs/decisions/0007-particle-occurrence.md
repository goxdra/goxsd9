...
alternatives or references to global Boolean/integer/decimal scalar elements; code generation also supports default-occurrence direct-choice references to those global
Boolean/integer/decimal elements, while all other validator and code-generator consumption of direct references remains unsupported. Global
