...
goxsd9 uses Go 1.26, the standard library, sequential execution, deterministic
observable ordering, immutable completed schema components, and structured
located diagnostics. Development occurs through worktree-backed issue claims,
fresh-context PR evaluation, and squash merges.
...
- The project accepts simpler sequential algorithms over concurrent machinery.
