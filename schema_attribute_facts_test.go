    ...
    <xs:restriction base="xs:NMTOKEN">
      <xs:enumeration value="imported"/>
			...
			wantAttributes := []struct {
				...
				{name: "directString", declaredType: mustTestQName(t, testXSDNamespace, "string"), typeLexical: "xs:string", atomicKind: schemaSimpleTypeAtomicString, whiteSpace: "preserve"},
				{name: "directNMTOKEN", declaredType: mustTestQName(t, testXSDNamespace, "NMTOKEN"), typeLexical: "xs:NMTOKEN", atomicKind: schemaSimpleTypeAtomicNMTOKEN, whiteSpace: "collapse", whiteSpaceFixed: true},
				{name: "namedString", declaredType: mustTestQName(t, "urn:root", "NamedString"), typeLexical: "r:NamedString", atomicKind: schemaSimpleTypeAtomicString, whiteSpace: "preserve", values: []string{" named "}, typeSource: "root.xsd"},
				{name: "inheritedNMTOKEN", declaredType: mustTestQName(t, "urn:root", "InheritedNMTOKEN"), typeLexical: "r:InheritedNMTOKEN", atomicKind: schemaSimpleTypeAtomicNMTOKEN, whiteSpace: "collapse", whiteSpaceFixed: true, values: []string{"child"}, typeSource: "root.xsd"},
				{name: "forwardString", declaredType: mustTestQName(t, "urn:root", "ForwardString"), typeLexical: "r:ForwardString", atomicKind: schemaSimpleTypeAtomicString, whiteSpace: "preserve", values: []string{"forward"}, typeSource: "root.xsd"},
				{name: "importedNMTOKEN", declaredType: mustTestQName(t, "urn:other", "ImportedNMTOKEN"), typeLexical: "o:ImportedNMTOKEN", atomicKind: schemaSimpleTypeAtomicNMTOKEN, whiteSpace: "collapse", whiteSpaceFixed: true, values: []string{"imported"}, typeSource: "other.xsd"},
				{name: "includedString", declaredType: mustTestQName(t, "urn:root", "IncludedString"), typeLexical: "r:IncludedString", atomicKind: schemaSimpleTypeAtomicString, whiteSpace: "preserve", values: []string{"included"}, typeSource: "chameleon.xsd"},
			}
...
func testSchemaBridgeGlobalAttributeUnsupportedTypes(t *testing.T) {
	unsupportedTypes := []string{"nonNegativeInteger"}
