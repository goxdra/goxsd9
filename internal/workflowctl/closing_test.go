...
func TestClosingIssueNumbersUseGitHubEffectiveMarkdownReferences(t *testing.T) {
	tests := []struct {
		...
		{name: "HTML style block", body: "<style>\nCloses #141\n</style>", want: nil},
		{name: "HTML textarea block", body: "<textarea>\nCloses #141\n</textarea>", want: nil},
		{name: "HTML xmp block", body: "<xmp>\nCloses #141\n</xmp>", want: nil},
		{name: "nested HTML blocks", body: "<div>\n<section>\n</section>\nCloses #141\n</div>", want: nil},
		{name: "HTML outer boundary", body: "<div>\n<section>\n</section>\n</div>\nCloses #141", want: []int{141}},
		{name: "list tilde fence", body: "- ~~~\n  Closes #141\n  ~~~\nCloses #142", want: []int{142}},
		{name: "ordered list tilde fence", body: "1. ~~~\n   Closes #141\n   ~~~\nCloses #142", want: []int{142}},
		{name: "nested list tilde fence", body: "- outer\n  - ~~~\n    Closes #141\n    ~~~\nCloses #142", want: []int{142}},
		{name: "nested container tilde fence", body: "> - ~~~\n>   Closes #141\n>   ~~~\nCloses #142", want: []int{142}},
		{name: "nested tilde fence remains masked", body: "- ~~~\n  - ~~~\n  Closes #141\n  - ~~~\n  ~~~\nCloses #142", want: []int{142}},
