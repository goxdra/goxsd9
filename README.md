...
Supported direct `xs:any` (`##any`/strict, `##any`/lax, `##other`/lax) retain non-`0/0` ranges/locations; `0/0` absent. `ValidateInstance`/`GenerateGo` reject wildcard consumers; other facts/placements unsupported. `anyAttribute`
