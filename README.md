...
XSD 1.0/1.1 graphs/restrictions supported; limited `precisionDecimal`/string facets/`openAttrs`/extensions. Global integer/decimal defaults/fixes immutable. Named global complexes: element-only bodies/`defaultAttributesApply` under XSD 1.1/Compatibility; mixed/default groups/malformed/contradictory, anonymous global/other shapes, local uses/attributes/wildcards/consumers unsupported. Choices/sequences: exact ranges/attribute-wildcards. Compatibility default; Strict10 reports 1.1 mismatch. `ValidateInstance`: named direct integer/decimal sequences/choices/refs; excludes global/local string/token values/particles, lists/unions, attributes. `GenerateGo`: global boolean/integer/decimal/string scalars (named/inherited; inline anonymous global strings); default numeric choices/sequences; only default-occurrence direct-choice references to global integer/decimal elements; other anonymous/repeated/reference shapes excluded.
