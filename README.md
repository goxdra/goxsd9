...
XSD 1.0/1.1 graphs/restrictions supported; limited `precisionDecimal`/string facets/`openAttrs`/extensions. Global integer/decimal defaults/fixes immutable. Named global complexes support element-only bodies/`defaultAttributesApply` in XSD 1.1/Compatibility; mixed/default groups, malformed/contradictory, anonymous global complex/other shapes, local uses/attributes, wildcards/consumers unsupported. Choices/sequences: exact ranges/attribute-wildcards. Compatibility default; Strict10 reports 1.1 mismatch. `ValidateInstance`: named direct integer/decimal sequences/scalar choices/refs; excludes global string/token values, local string/token particles, lists/unions, attributes. `GenerateGo`: global boolean/integer/decimal/atomic `xs:string` scalars (named/inherited; inline anonymous global string elements); default-choice/default-bounded integer/decimal sequences; other anonymous/inline unsupported.
