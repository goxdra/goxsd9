...
Diagnostics cover invalid/unsupported input; errors omit schema. `ValidateInstance` supports text-only integer/decimal; semantics unsupported. `GenerateGo` emits deterministic scalar Go; broader generation staged.
