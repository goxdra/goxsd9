...
Local built-in/named-effective `xs:long` particles in direct choices, sequences, and bounded attribute-free extensions are queryable under policies; consumers reject. Inline long/other local integer kinds unsupported; `nonNegativeInteger` 0/0 absent.
